...
namespace FixedspawnDissonance
{
    public class Soul
    {
        ...
        public static GameObject SoulArchWispBody = R2API.PrefabAPI.InstantiateClone(RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/CharacterBodies/ArchWispBody"), "SoulArchWispBody", true);
        public static GameObject SoulArchWispMaster = R2API.PrefabAPI.InstantiateClone(RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/CharacterMasters/ArchWispMaster"), "SoulArchWispMaster", true);
        ...
        public static void SoulWispCreator()
        {
            ...
            texBodyArchSoul.filterMode = FilterMode.Bilinear;
